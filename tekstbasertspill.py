def jægerHistorie():
  ...
  while userInput not in directions:
    print("Valg: 1 - Dreper han 2 - Dreper han ikke /skriv hjelp eller 3 hvis du ikke forstår")
    userInput = input()
...
def jægerhistorieEtterliv():
    ...
    userInput = ""
    while userInput not in directions:
      print("Valg: 1 - tar kontakt med folk 2 - holder deg for deg selv /skriv hjelp eller 3 hvis du ikke forstår")
      userInput = input()
...
def hærensValg():
  ...
  while userInput not in actions:
    print("Options: 1 - Jægersoldat 2 - Artillerist /skriv hjelp eller 3 hvis du ikke forstår")
    userInput = input()
...
def Kystvakt():
    ...
    userInput = ""
    while userInput not in directions:
      print("Valg: 1 - La de gå 2 - Undersøker nærmere skriv hjelp eller 3 hvis du ikke forstår")
      userInput = input()
